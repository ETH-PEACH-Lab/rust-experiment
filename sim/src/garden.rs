...
impl GardenState {
    pub fn new() -> Self {
        GardenState {
            ...
            can_y:           40.0,
            can_angle:       45.0,
            c1_day_h:  12.0,  c1_dark_h: 12.0,  c1_lux: 0.6,
            c2_day_h: 14.0,  c2_dark_h: 10.0,  c2_lux: 0.5,
            c3_day_h:  16.0,  c3_dark_h: 8.0,  c3_lux: 0.7,
            c4_day_h: 13.0,  c4_dark_h:  11.0,  c4_lux: 0.5,
            c5_day_h:  15.0,  c5_dark_h: 9.0,  c5_lux: 0.8,
            cycles_completed: 0,
        }
    }
    ...
    pub fn tick(&mut self, dt: f64) {
        ...
        self.temperature = solar_flux + 2.0;
